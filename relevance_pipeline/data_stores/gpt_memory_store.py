...
class MemoryVectorDataStore(DataStore):
    ...
    def __init__(self, loader = None, num_contexts:int = 6) -> None:
        self.filepaths_of_encoded_data = set()
        self.documents = []
        self.num_contexts = num_contexts
        # TODO: use dependency injection for loader - but for now, just set a default
        # since there's complications with different variables for different loaders
        if loader is None:
    ...
    def add_to_knowledge_store(self, source_filepath: str, metadata: dict = {}):
    ...
    def _rebuild_knowledge_store(self):
    ...
    def _update_knowledge_store(self):
